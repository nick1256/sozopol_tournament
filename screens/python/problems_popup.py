...
class ProblemsButtons(GridLayout):
	...
	def __init__(self, **kwargs):
		...
		self.add_widget(Button(text="Back", background_color=[1, 0, 0, 1],
                         on_press=(lambda x: self.parent.dismiss())))
		self.add_widget(Button(text="Continue", background_color=[0, 0, 1, 1],
                         on_press=(lambda x: self.parent.commit())))
