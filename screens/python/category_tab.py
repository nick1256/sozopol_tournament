...
class MatchWidget(Widget):
	...
	def lock(self):
		...
		team1 = self.ids.button_left.text
		team2 = self.ids.button_right.text
		jury1 = self.ids.button_top.text
		jury2 = self.ids.button_bottom.text
		return (team1, team2, jury1, jury2)
